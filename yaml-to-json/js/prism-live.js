...
;(async function () {
    ...
    constructor(source) {
      ...
      requestAnimationFrame(() => {
        ...
        this.pre.style.maxHeight =
          this.source.style.maxHeight || sourceCS.getPropertyValue("--max-height")
  ...
  Object.assign(_, {
    ...
    regexp: (() => {
      ...
      return new Proxy(_regexp.bind(_, ""), {
        get: (t, property) => {
          return t[property] || cache[property] || (cache[property] = _regexp.bind(_, property))
        },
      })
    })(),
  })
  ...
  $.ready().then(() => {
    $$(":not(.prism-live) > textarea.prism-live, :not(.prism-live) > pre.prism-live").forEach(
